...
OHLCV_CSV = r"data/ohlcv_with_rsi_divergence_flags_from_kite.csv"

# Training source:
# Option A: Use baseline "portfolio_run" trades + equity curves (original setup)
USE_BASELINE_TRADESET = True
BASELINE_RESULTS_PATH = r"data/rsi-divergence-portfolio-144"   # directory or .zip containing portfolio_run/
EXCLUDE_ETF = True
